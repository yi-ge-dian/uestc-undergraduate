...
public class CodeMsg {
	...
	//登录类错误码
	public static CodeMsg ADMIN_USERNAME_NO_EXIST = new CodeMsg(-3000, "该用户名或密码错误");
	public static CodeMsg ADMIN_PASSWORD_ERROR = new CodeMsg(-3001, "该用户名或密码错误");
	...
	public static CodeMsg ADMIN_GOODSCATEGORY_DELETE_ERROR = new CodeMsg(-9002, "该分类下纯在子分类或物品信息，不允许删除，请删除子分类以及物品信息后再操作");
	...
	public static CodeMsg ADMIN_GOODS_EDIT_ERROR = new CodeMsg(-9006, "物品状态编辑失败");
	public static CodeMsg ADMIN_GOODS_STATUS_UNABLE = new CodeMsg(-9007, "物品状态不可编辑（已出售不可上架）");
	public static CodeMsg ADMIN_GOODS_DELETE_ERROR = new CodeMsg(-9008, "物品删除失败，请联系管理员");
	//后台学生管理
	public static CodeMsg ADMIN_STUDENT_NO_EXIST = new CodeMsg(-9100, "学生不存在");
	public static CodeMsg ADMIN_STUDENT_STATUS_NO_CHANGE = new CodeMsg(-9101, "学生状态为发生变化");
	public static CodeMsg ADMIN_STUDENT_STATUS_ERROR = new CodeMsg(-9102, "学生状态错误");
	public static CodeMsg ADMIN_STUDENT_UPDATE_ERROR = new CodeMsg(-9103, "学生编辑错误，请联系管理员");
	public static CodeMsg ADMIN_STUDENT_DELETE_ERROR = new CodeMsg(-9104, "该学生下存在关联数据（物品等），请先删除关联数据");
	//后台评论管理
	public static CodeMsg ADMIN_COMMENT_DELETE_ERROR = new CodeMsg(-9200, "评论删除失败，请联系管理员");


	//前端用户登录注册类错误码
	public static CodeMsg HOME_STUDENT_REGISTER_SN_EXIST = new CodeMsg(-10000, "该学号已存在请勿重复注册");
	public static CodeMsg HOME_STUDENT_REGISTER_ERROR = new CodeMsg(-10001, "注册失败，请联系管理员");
	public static CodeMsg HOME_STUDENT_SN_NO_EXIST = new CodeMsg(-10002, "学号错误或密码错误");
	public static CodeMsg HOME_STUDENT_PASSWORD_ERROR = new CodeMsg(-10003, "学号错误或密码错误");
	public static CodeMsg HOME_STUDENT_UNABLE = new CodeMsg(-10004, "该用户已被冻结");
	//前端用户中心错误码
	public static CodeMsg HOME_STUDENT_EDITINFO_ERROR = new CodeMsg(-20000, "基本信息修改失,请联系管理员");
	public static CodeMsg HOME_STUDENT_EDITPWD_OLD_ERROR = new CodeMsg(-2001, "原密码错误");
	//前端用户发布物品错误码
	public static CodeMsg HOME_STUDENT_PUBLISH_ERROR = new CodeMsg(-30000, "物品发布失败，请联系管理员");
	public static CodeMsg HOME_STUDENT_GOODS_EDIT_ERROR = new CodeMsg(-30001, "物品编辑失败");
	...
	//前端用户评论
	public static CodeMsg HOME_STUDENT_COMMENT_ADD_ERROR = new CodeMsg(-50000, "评论失败，请练习管理员");
