package com.staging.base.service.admin;
import java.io.File;
...
import com.staging.base.dao.admin.DatabaseBakDao;
import com.staging.base.entity.admin.DatabaseBak;
...
public class DatabaseBakService {
	...
	@Value("${barter.database.backup.dir}")
	private String backUpDir;
	@Value("${barter.database.backup.username}")
	private String dbUsername;
	@Value("${barter.database.backup.password}")
	private String dbPwd;
	@Value("${barter.database.backup.database.name}")
