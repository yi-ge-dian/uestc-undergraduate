              ...
              <div class="card-body">
                <form action="add" id="category-add-form" method="post" class="row">
                  ...
                  <div class="input-group m-b-10">
                    ...
                    <input type="text" class="form-control required" id="name" name="name" value="${goodsCategory.name}" placeholder="请填写分类名称" tips="请填写分类名称" />
                  </div>
                  <div class="input-group m-b-10">
                    ...
                    <select name="parent.id" class="form-control" id="category">
                      <#if goodsCategorys??>
                        ...
                        <#list goodsCategorys as gc>
                          ...
                          <#if gc.id == goodsCategory.parent.id>
                          selected
                          </#if>
                          </#if>
                          >${gc.name}</option>
