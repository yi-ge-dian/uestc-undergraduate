        ...
        <div class="row">
            <div class="col-12">
                <div class="section__wrap">
                    <!-- section title -->
                    <h2 class="section__title">商品总数<span>共${pageBean.total}个商品</span></h2>
                    <!-- end section title -->

                    <!-- breadcrumb -->
                    <ul class="breadcrumb" >
                        <li class="breadcrumb__item"><a href="/home/index/index"><h4>回到首页</h4></a></li>
                        &nbsp;
                        <li class="breadcrumb__item breadcrumb__item--active"><a href="/home/index/index?name=${name!""}&currentPage=${pageBean.totalPage}"><h4>去尾页</h4></a></li>
                    </ul>
                    <!-- end breadcrumb -->
                </div>
            </div>
                        ...
                        <#list pageBean.content as goods>
                            <div class="col-12 col-sm-4 col-xl-4">
                                <div class="card">
                                    ...
                                    <img src="/photo/view?filename=${goods.photo}" alt="${goods.name}" width="300px" height="360px">
