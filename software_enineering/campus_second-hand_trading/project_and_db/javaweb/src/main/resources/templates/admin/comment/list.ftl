...
<title>${siteName!""}|评论管理-${title!""}</title>
                ...
                <#--<form class="pull-right search-bar" method="get" action="list" role="form">
                  <div class="input-group">
                    <div class="input-group-btn">
                      ...
                      物品名称 <span class="caret"></span>
                      </button>
                      <ul class="dropdown-menu">
                        <li> <a tabindex="-1" href="javascript:void(0)" data-field="title">物品名称</a> </li>
                      </ul>
                    </div>
                    <input type="text" class="form-control" value="${name!""}" name="name" placeholder="请输入评论内容">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="vertical-align:middle;">${comment.goods.name}</td>
                        <td style="vertical-align:middle;">
                          ${comment.student.sn}
                        </td>
                        <td style="vertical-align:middle;">
...
function deleteReq(id,url){
	$.ajax({
		...
		success:function(data){
			if(data.code == 0){
				showSuccessMsg('评论删除成功!',function(){
