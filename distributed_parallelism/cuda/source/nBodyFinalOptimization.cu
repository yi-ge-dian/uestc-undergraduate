...
int main(const int argc, const char** argv) {
  ...
  size_t numberOfBlocks = (nBodies + BLOCK_SIZE - 1) / BLOCK_SIZE;
  ...
  bodyForce<<<numberOfBlocks*BLOCK_REDO, BLOCK_SIZE>>>(d_p, dt, nBodies);// compute interbody forces

  integratePosition<<<numberOfBlocks,BLOCK_SIZE>>>(d_p,dt,nBodies);// integrate position
