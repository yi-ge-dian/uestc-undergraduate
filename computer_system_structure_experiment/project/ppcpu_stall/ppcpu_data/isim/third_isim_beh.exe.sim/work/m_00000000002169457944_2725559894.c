...
#endif
static const char *ng0 = "C:/Users/YiGeDian/Desktop/computer_system_structure_experiment/project/ppcpu_stall/ppcpu_data/alu.v";
...
LAB52:    if (*((unsigned int *)t136) > 0)
        goto LAB53;

LAB54:    if (*((unsigned int *)t110) > 0)
        goto LAB55;

LAB56:    memcpy(t109, t174, 8);

LAB57:    goto LAB32;

LAB33:    xsi_vlog_unsigned_bit_combine(t41, 32, t74, 32, t109, 32);
    goto LAB37;

LAB35:    memcpy(t41, t74, 8);
    goto LAB37;

LAB38:    t85 = *((unsigned int *)t74);
...
LAB76:    memcpy(t174, t225, 8);

LAB77:    goto LAB52;

LAB53:    xsi_vlog_unsigned_bit_combine(t109, 32, t143, 32, t174, 32);
    goto LAB57;

LAB55:    memcpy(t109, t143, 8);
    goto LAB57;

LAB58:    t154 = *((unsigned int *)t143);
    t155 = *((unsigned int *)t148);
    *((unsigned int *)t143) = (t154 | t155);
    t156 = (t141 + 4);
    t157 = (t142 + 4);
...
LAB92:    if (*((unsigned int *)t252) > 0)
        goto LAB93;

LAB94:    if (*((unsigned int *)t226) > 0)
        goto LAB95;

LAB96:    memcpy(t225, t264, 8);

LAB97:    goto LAB72;

LAB73:    xsi_vlog_unsigned_bit_combine(t174, 32, t208, 32, t225, 32);
    goto LAB77;

LAB75:    memcpy(t174, t208, 8);
    goto LAB77;

LAB78:    t219 = *((unsigned int *)t208);
...
LAB89:    t256 = (t0 + 1208U);
    ...
    t258 = *((char **)t256);
    memset(t259, 0, 8);
    xsi_vlog_unsigned_rshift(t259, 32, t257, 32, t258, 32);
    goto LAB90;
...
LAB111:    if (*((unsigned int *)t265) > 0)
        goto LAB112;

LAB113:    memcpy(t264, t302, 8);

LAB114:    goto LAB92;

LAB93:    xsi_vlog_unsigned_bit_combine(t225, 32, t259, 32, t264, 32);
    goto LAB97;

LAB95:    memcpy(t225, t259, 8);
    goto LAB97;
...
LAB130:    memcpy(t302, t332, 8);

LAB131:    goto LAB109;

LAB110:    xsi_vlog_unsigned_bit_combine(t264, 32, t297, 32, t302, 32);
    goto LAB114;

LAB112:    memcpy(t264, t297, 8);
    goto LAB114;
...
LAB123:    t332 = (t0 + 1048U);
    t333 = *((char **)t332);
    t332 = (t0 + 1208U);
    t334 = *((char **)t332);
    memset(t335, 0, 8);
    xsi_vlog_unsigned_minus(t335, 32, t333, 32, t334, 32);
    goto LAB124;

LAB125:    t332 = ((char*)((ng8)));
    goto LAB126;

LAB127:    xsi_vlog_unsigned_bit_combine(t302, 32, t335, 32, t332, 32);
    goto LAB131;
...
extern void work_m_00000000002169457944_2725559894_init()
{
	static char *pe[] = {(void *)Cont_29_0,(void *)Cont_38_1};
	xsi_register_didat("work_m_00000000002169457944_2725559894", "isim/third_isim_beh.exe.sim/work/m_00000000002169457944_2725559894.didat");
